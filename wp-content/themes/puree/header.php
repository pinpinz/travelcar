...
>
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    <div class="vd to/4 tc wf yf">
      <a href="index.html">
        <img class="om" src="<?php bloginfo('template_directory');?>/images/logo-new.png" alt="Logo Light" />
        <img class="xc nm" src="<?php bloginfo('template_directory');?>/images/logo-new.png" alt="Logo Dark" />
      </a>
      ...
      <div class="tc wf ig pb no">
        <!-- <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
          <label class="rc ab i">
            ...
            <!-- Icon Sun -->
            <!-- <img class="xc nm" src="<?php bloginfo('template_directory');?>/images/icon-moon.svg" alt="Moon" />
          </label> -->
        </div>
