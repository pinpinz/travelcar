...
<main class="mt-10">
    ...
    <section id="features">
          ...
          <div class="tc uf zo xf ap zf bp mq">
            ...
            <div class="animate_top kn to/3 tc cg oq">
              <div class="tc wf xf cf ae cd rg nh">
                <img src="<?php bloginfo('template_directory');?>/images/icon-02.svg" alt="Icon" />
              </div>
              <div>
            ...
            <div class="animate_top kn to/3 tc cg oq">
              <div class="tc wf xf cf ae cd rg oh">
                <img src="<?php bloginfo('template_directory');?>/images/icon-03.svg" alt="Icon" />
              </div>
              <div>
      ...
      <section class="i pg ji gp uq">
        ...
        <img src="<?php bloginfo('template_directory');?>/images/shape-08.svg" alt="Shape Bg" class="h q r" />
        <img src="<?php bloginfo('template_directory');?>/images/shape-09.svg" alt="Shape" class="of h y z/2" />
        <img src="<?php bloginfo('template_directory');?>/images/shape-10.svg" alt="Shape" class="h _ aa" />
        <img src="<?php bloginfo('template_directory');?>/images/shape-11.svg" alt="Shape" class="of h m ba" />
          ...
          <div class="wc qf pn xo gg cp">
            ...
            <div class="animate_top rj">
              <div class="c i pg z-1">
                <img class="vd" src="<?php bloginfo('template_directory');?>/images/team-01.png" alt="Team" />
            ...
            <div class="animate_top rj">
              <div class="c i pg z-1">
                <img class="vd" src="<?php bloginfo('template_directory');?>/images/team-02.png" alt="Team" />
            ...
            <div class="animate_top rj">
              <div class="c i pg z-1">
                <img class="vd" src="<?php bloginfo('template_directory');?>/images/team-03.png" alt="Team" />
    ...
    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
        ...
        <div class="bb ze ki xn yq mb en">
          <div class="wc qf pn xo ng">
            ...
            <!-- Service Item -->
            <div class="animate_top sg oi pi zq ml il am cn _m">
              <img src="<?php bloginfo('template_directory');?>/images/icon-07.svg" alt="Icon" />
          ...
          <div class="projects-wrapper tc -ud-mx-5">
            ...
            <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
              <div class="c i pg sg z-1">
                <img src="<?php bloginfo('template_directory');?>/images/project-01.png" alt="Project" />
            ...
            <div class="project-item wi fb vd jn/2 to/3 digital">
              <div class="c i pg sg z-1">
                <img src="<?php bloginfo('template_directory');?>/images/project-02.png" alt="Project" />
            ...
            <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
              <div class="c i pg sg z-1">
                <img src="<?php bloginfo('template_directory');?>/images/project-04.png" alt="Project" />
            ...
            <div class="project-item wi fb vd vo/3 digital ecommerce">
              <div class="c i pg sg z-1">
                <img src="<?php bloginfo('template_directory');?>/images/project-03.png" alt="Project" />
    ...
    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
                ...
                <div class="swiper-slide">
                  <div class="i hh rm sg vk xm bi qj">
                    ...
                    <div class="tc sf rn tn un zf dp">
                      <img class="bf" src="<?php bloginfo('template_directory');?>/images/testimonial.png" alt="User" />
                      ...
                      <div>
                        ...
                        <div class="tc yf vf">
                          ...
                          <img class="rk" src="<?php bloginfo('template_directory');?>/images/brand-light-02.svg" alt="Brand" />
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <section class="i pg qh rm ji hp">
        <img src="<?php bloginfo('template_directory');?>/images/shape-11.svg" alt="Shape" class="of h ga ha ke" />
        <img src="<?php bloginfo('template_directory');?>/images/shape-07.svg" alt="Shape" class="h ia o ae jf" />
        <img src="<?php bloginfo('template_directory');?>/images/shape-14.svg" alt="Shape" class="h ja ka" />
        <img src="<?php bloginfo('template_directory');?>/images/shape-15.svg" alt="Shape" class="h q p" />
        ...
        <div class="bb ze ah ch pm hj xp ki xn 2xl:ud-px-49 bc">
          <div class="wc rf qn zf cp kq xf wf">
            <a href="#" class="rc animate_top">
              <img class="th wl ml il zl om" src="<?php bloginfo('template_directory');?>/images/brand-light-01.svg" alt="Clients" />
              <img class="xc sk ml il zl nm" src="<?php bloginfo('template_directory');?>/images/brand-dark-01.svg" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="<?php bloginfo('template_directory');?>/images/brand-light-02.svg" alt="Clients" />
              <img class="xc sk ml il zl nm" src="<?php bloginfo('template_directory');?>/images/brand-dark-02.svg" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="<?php bloginfo('template_directory');?>/images/brand-light-03.svg" alt="Clients" />
              <img class="xc sk ml il zl nm" src="<?php bloginfo('template_directory');?>/images/brand-dark-03.svg" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="<?php bloginfo('template_directory');?>/images/brand-light-04.svg" alt="Clients" />
              <img class="xc sk ml il zl nm" src="<?php bloginfo('template_directory');?>/images/brand-dark-04.svg" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="<?php bloginfo('template_directory');?>/images/brand-light-05.svg" alt="Clients" />
              <img class="xc sk ml il zl nm" src="<?php bloginfo('template_directory');?>/images/brand-dark-05.svg" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="<?php bloginfo('template_directory');?>/images/brand-light-06.svg" alt="Clients" />
              <img class="xc sk ml il zl nm" src="<?php bloginfo('template_directory');?>/images/brand-dark-06.svg" alt="Clients" />
            </a>
          </div>
        </div>
      </section>
          ...
          <div class="wc qf pn xo zf iq">
            ...
            <div class="animate_top sg vk rm xm">
              <div class="c rc i z-1 pg">
                <img class="w-full" src="<?php bloginfo('template_directory');?>/images/blog-01.png" alt="Blog" />
            ...
            <div class="animate_top sg vk rm xm">
              <div class="c rc i z-1 pg">
                <img class="w-full" src="<?php bloginfo('template_directory');?>/images/blog-02.png" alt="Blog" />
            ...
            <div class="animate_top sg vk rm xm">
              <div class="c rc i z-1 pg">
                <img class="w-full" src="<?php bloginfo('template_directory');?>/images/blog-03.png" alt="Blog" />
        ...
        <div class="i va bb ye ki xn wq jb mo">
          <div class="tc uf sn tf rn un zf xl:gap-10">
            <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
              <!-- Bg Shapes -->
              <img src="<?php bloginfo('template_directory');?>/images/shape-03.svg" alt="Shape" class="h la x wd" />
              <img src="<?php bloginfo('template_directory');?>/images/shape-06.svg" alt="Shape" class="h la ma ne kf" />
